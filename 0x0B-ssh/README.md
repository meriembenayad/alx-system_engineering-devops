...
Along with this project, you have been attributed an Ubuntu server, living in a datacenter far far away. Like level 2 of the application process, you will connect using `ssh`. But contrary to level 2, you will not connect using a password but an RSA key. We’ve configured your server with the public key you created in the first task of [a previous project](https://github.com/meriembenayad/alx-system_engineering-devops/tree/master/0x04-loops_conditions_and_parsing) shared in your [intranet profile](https://intranet.alxswe.com/rltoken/8ZlNV0J-sa-dijhmhJolOg "intranet profile").
...
<details>
<summary>0. Use a private key</summary>
...
<details>
<summary>1. Create an SSH key pair</summary>
...
<details>
<summary>2. Client configuration file</summary>
...
<details>
<summary>4. Client configuration file (w/ Puppet)</summary>

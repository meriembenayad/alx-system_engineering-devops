...
[![](diagram-what-is-an-api-postman-illustration.svg)](https://youtu.be/-2kyU6-j8ZQ)
...
Develop a Python script that utilizes this [REST API](https://jsonplaceholder.typicode.com/) to fetch and display the TODO list progress of an employee, given their ID.

**_Specifications:_**

- The script should incorporate the `urllib` or `requests` module.
- The script should take an integer as an argument, representing the employee ID.
- The script should present the progress of the employee's TODO list on the standard output in the following precise format:
  - The first line: `Employee EMPLOYEE_NAME is done with tasks(NUMBER_OF_DONE_TASKS/TOTAL_NUMBER_OF_TASKS):`
    - `EMPLOYEE_NAME`: the name of the employee.
    - `NUMBER_OF_DONE_TASKS`: the count of tasks that have been completed.
    - `TOTAL_NUMBER_OF_TASKS`: the total count of tasks, which is the sum of completed and non-completed tasks.
  - The second line and all subsequent lines should display the title of completed tasks: `TASK_TITLE` (preceded by 1 tabulation and 1 space).
...
Building on what you accomplished in `task #0`, enhance your Python script to export data in CSV format.

**_Prerequisites:_**

- The script should document all tasks assigned to the specified employee.
- The data should be formatted as follows: `"USER_ID","USERNAME","TASK_COMPLETED_STATUS","TASK_TITLE"`.
- The output file should be named using the `USER_ID.csv` format.
...
Building on the work you did in task #0, enhance your Python script to export data in the JSON format.

**_Specifications:_**

- The script should document all tasks assigned to the specified employee.
- The data should be formatted as follows: `{ "USER_ID": [{"task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS, "username": "USERNAME"}, {"task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS, "username": "USERNAME"}, ... ]}`.
- The output file should be named using the `USER_ID.json` format.
...
<details>
<summary>3. Dictionary of list of dictionaries</summary>

Building on the work you did in task #0, enhance your Python script to export data in the JSON format.

**_Specifications:_**

- The script should document all tasks from all employees.
- The data should be formatted as follows: `{ "USER_ID": [ {"username": "USERNAME", "task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS}, {"username": "USERNAME", "task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS}, ... ], "USER_ID": [ {"username": "USERNAME", "task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS}, {"username": "USERNAME", "task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS}, ... ]}`.
- The output file should be named `todo_all_employees.json`.
